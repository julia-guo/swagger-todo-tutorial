...
import (
	...
	"net/http"
	"swagger-todo/models"
	"swagger-todo/restapi/operations"
	"swagger-todo/restapi/operations/todos"
	"sync"
	"sync/atomic"
...
//go:generate swagger generate server --target ../../swagger-todo --name TodoList --spec ../swagger.yml --principal interface{}
